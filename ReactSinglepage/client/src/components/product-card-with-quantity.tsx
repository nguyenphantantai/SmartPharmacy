...
export default function ProductCardWithQuantity({ product }: ProductCardWithQuantityProps) {
      ...
      <div className="bg-white rounded-xl overflow-hidden shadow-md">
        ...
        <div className="px-4 pb-4">
          ...
          <div className="space-y-2">
            <Button 
              onClick={() => {
                console.log('🛒 Clicking "Chọn sản phẩm" for:', product.name);
                console.log('🛒 Current isPopupOpen state:', isPopupOpen);
                setIsPopupOpen(true);
                console.log('🛒 Set isPopupOpen to true');
              }}
