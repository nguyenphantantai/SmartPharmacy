...
export default function ToothPowderPage() {
  ...
  const toothPowderProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Bột đánh răng");
  }, []);

  const brands = useMemo(() => {
    const allBrands = toothPowderProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = toothPowderProducts;
    ...
    return filtered;
  }, [toothPowderProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Bột đánh răng</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Bột đánh răng</h1>
