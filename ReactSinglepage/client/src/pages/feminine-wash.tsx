...
export default function FeminineWashPage() {
  ...
  const feminineWashProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Dung dịch vệ sinh phụ nữ");
  }, []);

  const brands = useMemo(() => {
    const allBrands = feminineWashProducts.map((p) => p.brand);
    return Array.from(new Set(allBrands));
  }, [feminineWashProducts]);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = feminineWashProducts;
    ...
    return filtered;
  }, [feminineWashProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Dung dịch vệ sinh phụ nữ</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Dung dịch vệ sinh phụ nữ</h1>
