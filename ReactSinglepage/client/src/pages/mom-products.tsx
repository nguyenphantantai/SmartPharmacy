...
export default function MomProductsPage() {
  ...
  const categories = [
    { label: "Phụ kiện cho mẹ", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192839-0-P20532_1.png", link: "/phu-kien-cho-me" },
    { label: "Dụng cụ chăm sóc cho mẹ", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192726-0-P17661_1_l.png", link: "/dung-cu-cham-soc-cho-me" },
  ];

  const brands = useMemo(() => {
    const momProducts = momBabyProducts.filter(p => p.category === "Sản phẩm dành cho mẹ");
    const allBrands = momProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.category === "Sản phẩm dành cho mẹ");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sản phẩm dành cho mẹ</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sản phẩm dành cho mẹ</h1>
