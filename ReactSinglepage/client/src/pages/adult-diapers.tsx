...
export default function AdultDiapersPage() {
  ...
  const adultDiaperProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Tã dán");
  }, []);

  const brands = useMemo(() => {
    const allBrands = adultDiaperProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = adultDiaperProducts;
    ...
    return filtered;
  }, [adultDiaperProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Tã dán</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Tã dán</h1>
