...
export default function BabyHealthCarePage() {
  ...
  const brands = useMemo(() => {
    const healthCareProducts = momBabyProducts.filter(p => p.subCategory === "Sản phẩm chăm sóc sức khoẻ cho bé");
    const allBrands = healthCareProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Sản phẩm chăm sóc sức khoẻ cho bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sản phẩm chăm sóc sức khoẻ cho bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sản phẩm chăm sóc sức khoẻ cho bé</h1>
