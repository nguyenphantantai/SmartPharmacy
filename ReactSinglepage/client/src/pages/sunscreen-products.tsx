...
export default function SunscreenProductsPage() {
  ...
  const sunscreenProducts = useMemo(() => {
    return beautyCareProducts.filter(product => product.category === "Sản phẩm chống nắng");
  }, []);

  const brands = useMemo(() => {
    const allBrands = sunscreenProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = sunscreenProducts;
    ...
    return filtered;
  }, [sunscreenProducts, priceRange, minPrice, maxPrice, selectedBrands]);
  ...
  const productTypes = [
    {
      label: "Kem chống nắng dành cho mặt",
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241022102724-0-P10576.jpg?versionId=MpcO.tmKHBKc.lHM13ertJSmD9KyZduY",
      link: "/kem-chong-nang-danh-cho-mat"
    },
    {
      label: "Kem chống nắng cho mặt và cơ thể",
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/ecommerce/20240225114754-0-P00386_1.png",
      link: "/kem-chong-nang-cho-mat-va-co-the"
    },
  ];
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sản phẩm chống nắng</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sản phẩm chống nắng</h1>
