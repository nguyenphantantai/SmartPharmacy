...
export default function RollOnDeodorantPage() {
  ...
  // Lọc sản phẩm lăn khử mùi
  const rollOnProducts = useMemo(() => {
    return personalCareProducts.filter(product => 
      product.category === "Sản phẩm khử mùi" && product.subCategory === "Lăn khử mùi"
    );
  }, []);

  const brands = useMemo(() => {
    const allBrands = rollOnProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [rollOnProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/san-pham-khu-mui">Sản phẩm khử mùi</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Lăn khử mùi</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Lăn khử mùi</h1>
