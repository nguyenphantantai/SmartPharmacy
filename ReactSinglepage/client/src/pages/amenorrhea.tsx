...
export default function AmenorrheaPage() {
      ...
      <main className="mx-auto max-w-screen-2xl px-6 py-8">
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Mất kinh</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            {/* Article Header */}
            <div className="mb-8">
              <div className="text-sm text-gray-500 mb-2">12/06/2024</div>
              <h1 className="text-3xl font-bold text-gray-900 mb-4">
                Mất kinh: Nguyên nhân, triệu chứng và cách phòng ngừa
              </h1>
            ...
            <div className="prose max-w-none">
              ...
              <div id="overview" className="space-y-6 mb-12">
                <h2 className="text-2xl font-bold mb-4">Tổng quan chung về mất kinh là gì</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Mất kinh là một tình trạng ảnh hưởng đến cuộc sống hàng ngày và tâm lý của người bệnh, 
                  có thể do nhiều yếu tố gây ra (bao gồm lối sống và mất cân bằng hormone). 
                  Việc nhận biết và điều trị sớm là rất quan trọng. Hãy cùng tìm hiểu chi tiết về mất kinh, 
                  nguyên nhân và cách điều trị trong bài viết dưới đây.
                </p>

                <p className="text-gray-700 leading-relaxed mb-4">
                  Mất kinh (hay còn gọi là vô kinh) là tình trạng phụ nữ không có kinh nguyệt, 
                  bao gồm việc mất đi một hoặc nhiều chu kỳ kinh nguyệt. Tình trạng này được chia thành hai loại chính:
                </p>

                <h3 className="text-xl font-semibold mb-3">Mất kinh nguyệt nguyên phát:</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Là trường hợp một người chưa từng có kinh nguyệt khi đã 15 tuổi trở lên, 
                  mặc dù đã có các dấu hiệu khác của tuổi dậy thì. Theo Trung tâm Thông tin Công nghệ Sinh học Quốc gia (NCBI), 
                  mất kinh nguyên phát được định nghĩa là không có kinh nguyệt ở phụ nữ trên 15 tuổi 
                  hoặc 3 năm sau khi bắt đầu phát triển ngực, với nguyên nhân bao gồm rối loạn nhiễm sắc thể, 
                  bất thường tử cung hoặc buồng trứng.
                </p>

                <h3 className="text-xl font-semibold mb-3">Mất kinh nguyệt thứ phát:</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Là tình trạng một người trước đó đã có kinh nguyệt nhưng mất đi 3 chu kỳ liên tiếp. 
                  Tình trạng này có thể là tạm thời hoặc liên tục, rất ít trường hợp là vĩnh viễn. 
                  Theo Cleveland Clinic, mất kinh thứ phát được định nghĩa là không có kinh nguyệt ít nhất 3 tháng 
                  ở phụ nữ trước đó đã có chu kỳ kinh nguyệt, với nguyên nhân bao gồm mang thai, cho con bú, 
                  stress, giảm cân đột ngột hoặc tập thể dục quá mức.
                </p>

                <h3 className="text-xl font-semibold mb-3">Đặc điểm của mất kinh:</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  <li><strong>Tên khoa học:</strong> Amenorrhea</li>
                  <li><strong>Tính chất:</strong> Không có kinh nguyệt</li>
                  <li><strong>Triệu chứng chính:</strong> Mất kinh nguyệt</li>
                ...
                <div className="mt-8 bg-blue-50 rounded-lg p-4">
                  <a href="#" className="text-blue-600 hover:underline font-medium">
                    Xem thêm thông tin: Tắc kinh nguyệt là gì? Cách tự điều trị tại nhà an toàn, hiệu quả!
                  </a>
                </div>
              </div>
              ...
              <div id="symptoms" className="space-y-6 mb-12">
                <h2 className="text-2xl font-bold mb-4">Triệu chứng của Mất kinh</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Triệu chứng chính của mất kinh là không có kinh nguyệt. 
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                  <li><strong>Không có kinh:</strong> Mất kinh nguyệt hoàn toàn</li>
                  <li><strong>Thay đổi chu kỳ:</strong> Chu kỳ không đều</li>
                  <li><strong>Thay đổi cân nặng:</strong> Tăng/giảm cân</li>
                  <li><strong>Thay đổi tâm trạng:</strong> Lo âu, trầm cảm</li>
                  <li><strong>Mệt mỏi:</strong> Cảm giác yếu ớt</li>
                  <li><strong>Thay đổi da:</strong> Da khô, mụn</li>
                </ul>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">PCOS</h4>
                    <ul className="list-disc list-inside space-y-1 text-gray-700">
                      <li>Tăng cân</li>
                      <li>Mụn trứng cá</li>
                      <li>Lông mọc nhiều</li>
                      <li>Rụng tóc</li>
                    </ul>
                  </div>
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-yellow-800 mb-2">Stress</h4>
                    <ul className="list-disc list-inside space-y-1 text-gray-700">
                      <li>Lo âu</li>
                      <li>Mất ngủ</li>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  ...
                  <li><strong>Thay đổi vú:</strong> Tiết sữa</li>
                  <li><strong>Thay đổi giọng nói:</strong> Giọng trầm</li>
                  <li><strong>Thay đổi da:</strong> Da sậm màu</li>
                  <li><strong>Thay đổi tóc:</strong> Rụng tóc</li>
                </ul>
              </div>

              {/* Nguyên nhân */}
              <div id="causes" className="space-y-6 mb-12">
                <h2 className="text-2xl font-bold mb-4">Nguyên nhân gây Mất kinh</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Mất kinh có thể do nhiều nguyên nhân khác nhau, từ các yếu tố sinh lý bình thường 
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                  ...
                  <li><strong>Tuổi dậy thì:</strong> Chưa có kinh</li>
              ...
              <div id="risk-factors" className="space-y-6 mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Một số phụ nữ có nguy cơ cao bị mất kinh hơn những người khác. 
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                  <li><strong>Tuổi:</strong> Tuổi dậy thì, mãn kinh</li>
              ...
              <div id="diagnosis" className="space-y-6 mb-12">
                <h2 className="text-2xl font-bold mb-4">Chẩn đoán Mất kinh</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Chẩn đoán mất kinh dựa trên tiền sử bệnh, khám lâm sàng và các xét nghiệm cần thiết. 
              ...
              <div id="prevention" className="space-y-6 mb-12">
                <h2 className="text-2xl font-bold mb-4">Phòng ngừa Mất kinh</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Phòng ngừa mất kinh tập trung vào việc duy trì lối sống lành mạnh và 
              ...
              <div id="treatment" className="space-y-6 mb-12">
                <h2 className="text-2xl font-bold mb-4">Điều trị Mất kinh</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Điều trị mất kinh tùy thuộc vào nguyên nhân gây bệnh. 
