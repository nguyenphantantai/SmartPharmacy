...
export default function BeautyToolsPage() {
  ...
  const beautyToolsProducts = useMemo(() => {
    return beautyCareProducts.filter(product => product.category === "Dụng cụ làm đẹp");
  }, []);

  const brands = useMemo(() => {
    const allBrands = beautyToolsProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = beautyToolsProducts;
    ...
    return filtered;
  }, [beautyToolsProducts, priceRange, minPrice, maxPrice, selectedBrands]);
  ...
  const productTypes = [
    {
      ...
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/ecommerce/20240225120552-0-P01447_11.png",
      link: "/phu-kien-trang-diem"
    },
    {
      label: "Bông tẩy trang/Tăm bông",
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241023043124-0-P08283_1.png?versionId=M5YYDJnCpL8ZkzJiPWbVa79RlY1JKy52",
      link: "/bong-tay-trang-tam-bong"
    },
  ];
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Dụng cụ làm đẹp</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Dụng cụ làm đẹp</h1>
