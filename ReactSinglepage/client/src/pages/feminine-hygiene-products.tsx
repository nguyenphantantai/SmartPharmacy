...
import FeminineHygieneProductGrid from "../components/feminine-hygiene-product-grid";
import { useState, useMemo } from "react";
import { personalCareProducts } from "@/data/personal-care";
import { Link } from "wouter";

export default function FeminineHygieneProductsPage() {
  ...
  // Lọc sản phẩm vệ sinh phụ nữ
  const feminineHygieneProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.category === "Vệ sinh phụ nữ");
  }, []);

  const brands = useMemo(() => {
    const allBrands = feminineHygieneProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = feminineHygieneProducts;
    ...
    return filtered;
  }, [feminineHygieneProducts, priceRange, minPrice, maxPrice, selectedBrands]);
  ...
  const productTypes = [
    { 
      label: "Sản phẩm vệ sinh khác", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241024100937-0-P12836_1.png?versionId=77Ep6kXZKG1AUORjRlBC9s.36C3aUTWs",
      link: "/san-pham-ve-sinh-khac"
    },
    { 
      label: "Tã dán", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241024100548-0-P12847_5.jpg?versionId=iH3.QKWWMPpW.o7lFid0.QFwjgIQh9kp",
      link: "/ta-dan"
    },
    { 
      label: "Dung dịch vệ sinh phụ nữ", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241024100836-0-P09608_1.png?versionId=ULwmDjnPGHy0t5am8g9jJh6l07lS1keH",
      link: "/dung-dich-ve-sinh-phu-nu"
    },
    { 
      label: "Băng vệ sinh", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241024100722-0-P18774_1.png?versionId=76yS209rxKvpgfmDIk3LJ_u05eZsQdnL",
      link: "/bang-ve-sinh"
    },
  ];
      ...
      <main className="mx-auto max-w-screen-2xl px-6 py-8">
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Vệ sinh phụ nữ</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Vệ sinh phụ nữ</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
          ...
          <section>
            ...
            <FeminineHygieneProductGrid products={filteredProducts} />
          </section>
        </div>
      </main>
