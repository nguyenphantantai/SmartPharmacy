...
export default function BabyMosquitoRepellentPage() {
  ...
  const brands = useMemo(() => {
    const repellentProducts = momBabyProducts.filter(p => p.subCategory === "Sản phẩm chống muỗi cho bé");
    const allBrands = repellentProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Sản phẩm chống muỗi cho bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sản phẩm chống muỗi cho bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sản phẩm chống muỗi cho bé</h1>
