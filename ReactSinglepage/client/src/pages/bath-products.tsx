...
export default function BathProductsPage() {
  ...
  // Lọc sản phẩm phòng tắm
  const bathProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.category === "Sản phẩm phòng tắm");
  }, []);

  const brands = useMemo(() => {
    const allBrands = bathProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [bathProducts, priceRange, minPrice, maxPrice, selectedBrands]);
  ...
  const productTypes = [
    { 
      label: "Sữa tắm", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241024031233-0-P12966_1.jpg?versionId=h8l5ew7PiuYvpWQ7sC9HEAUxoCXrdxlc",
      link: "/sua-tam"
    },
    { 
      label: "Xà phòng tắm", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/ecommerce/20240225091316-0-P17538_1.png",
      link: "/xa-phong-tam"
    },
    { 
      label: "Nước rửa tay", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/ecommerce/20240225091147-0-P03374_1.png",
      link: "/nuoc-rua-tay"
    },
  ];
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sản phẩm phòng tắm</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sản phẩm phòng tắm</h1>
