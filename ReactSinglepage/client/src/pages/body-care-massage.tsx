...
export default function BodyCareMassagePage() {
  ...
  const bodyCareMassageProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Dưỡng thể & massage");
  }, []);

  const brands = useMemo(() => {
    const allBrands = bodyCareMassageProducts.map((p) => p.brand);
    return Array.from(new Set(allBrands));
  }, [bodyCareMassageProducts]);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = bodyCareMassageProducts;
    ...
    return filtered;
  }, [bodyCareMassageProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Dưỡng thể & massage</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Dưỡng thể & massage</h1>
