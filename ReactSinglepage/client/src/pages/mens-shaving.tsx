...
export default function MensShavingPage() {
  ...
  const mensShavingProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Dao cạo râu & Bọt cạo râu");
  }, []);

  const brands = useMemo(() => {
    const allBrands = mensShavingProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = mensShavingProducts;
    ...
    return filtered;
  }, [mensShavingProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Dao cạo râu & Bọt cạo râu</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Dao cạo râu & Bọt cạo râu</h1>
