...
export default function TonerMistProductsPage() {
  ...
  const tonerMistProducts = useMemo(() => {
    return beautyCareProducts.filter(product => product.subCategory === "Nước cân bằng & xịt khoáng");
  }, []);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Nước cân bằng & xịt khoáng</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Nước cân bằng & xịt khoáng</h1>
