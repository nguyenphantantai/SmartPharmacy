...
export default function BabyDiapersPage() {
  ...
  const brands = useMemo(() => {
    const diapersProducts = momBabyProducts.filter(p => p.subCategory === "Tã cho bé");
    const allBrands = diapersProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Tã cho bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Tã cho bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Tã cho bé</h1>
