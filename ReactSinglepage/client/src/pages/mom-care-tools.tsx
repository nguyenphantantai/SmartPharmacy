...
export default function MomCareToolsPage() {
  ...
  const brands = useMemo(() => {
    const careToolsProducts = momBabyProducts.filter(p => p.subCategory === "Dụng cụ chăm sóc cho mẹ");
    const allBrands = careToolsProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Dụng cụ chăm sóc cho mẹ");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/san-pham-danh-cho-me">Sản phẩm dành cho mẹ</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Dụng cụ chăm sóc cho mẹ</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Dụng cụ chăm sóc cho mẹ</h1>
