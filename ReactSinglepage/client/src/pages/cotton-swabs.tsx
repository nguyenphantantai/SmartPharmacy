...
export default function CottonSwabsPage() {
  ...
  const cottonSwabsProducts = useMemo(() => {
    return beautyCareProducts.filter(product => product.subCategory === "Bông tẩy trang/Tăm bông");
  }, []);

  const brands = useMemo(() => {
    const allBrands = cottonSwabsProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = cottonSwabsProducts;
    ...
    return filtered;
  }, [cottonSwabsProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Bông tẩy trang/Tăm bông</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Bông tẩy trang/Tăm bông</h1>
