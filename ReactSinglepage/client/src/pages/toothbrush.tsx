...
export default function ToothbrushPage() {
  ...
  const toothbrushProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Bàn chải đánh răng");
  }, []);

  const brands = useMemo(() => {
    const allBrands = toothbrushProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = toothbrushProducts;
    ...
    return filtered;
  }, [toothbrushProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Bàn chải đánh răng</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Bàn chải đánh răng</h1>
