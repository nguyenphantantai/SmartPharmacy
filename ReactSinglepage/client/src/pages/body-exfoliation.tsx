...
export default function BodyExfoliationPage() {
  ...
  const bodyExfoliationProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Tẩy tế bào chết toàn thân");
  }, []);

  const brands = useMemo(() => {
    const allBrands = bodyExfoliationProducts.map((p) => p.brand);
    return Array.from(new Set(allBrands));
  }, [bodyExfoliationProducts]);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = bodyExfoliationProducts;
    ...
    return filtered;
  }, [bodyExfoliationProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/cham-soc-co-the">Chăm sóc cơ thể</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Tẩy tế bào chết toàn thân</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Tẩy tế bào chết toàn thân</h1>
