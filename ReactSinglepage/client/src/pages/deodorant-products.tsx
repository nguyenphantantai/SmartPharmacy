...
import DeodorantProductGrid from "../components/deodorant-product-grid";
import { useState, useMemo } from "react";
import { personalCareProducts } from "@/data/personal-care";
import { Link } from "wouter";

export default function DeodorantProductsPage() {
  ...
  // Lọc sản phẩm khử mùi
  const deodorantProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.category === "Sản phẩm khử mùi");
  }, []);

  const brands = useMemo(() => {
    const allBrands = deodorantProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = deodorantProducts;
    ...
    return filtered;
  }, [deodorantProducts, priceRange, minPrice, maxPrice, selectedBrands]);
  ...
  const productTypes = [
    { 
      label: "Lăn khử mùi", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241024031002-0-P07609_1.jpg?versionId=2jmvt9PF7pTt3UuJoVM_kEOe7LithZ.z",
      link: "/lan-khu-mui"
    },
    { 
      label: "Sáp khử mùi", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/product/20241025034918-0-P26024_1.jpg?versionId=OhYip_KnYKWlTcsqjcdUkoQYACvgvT_j",
      link: "/sap-khu-mui"
    },
    { 
      label: "Xịt khử mùi", 
      imageUrl: "https://production-cdn.pharmacity.io/digital/256x256/plain/e-com/images/ecommerce/20240225091510-0-P16681_1%20%281%29.png",
      link: "/xit-khu-mui"
    },
  ];
      ...
      <main className="mx-auto max-w-screen-2xl px-6 py-8">
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sản phẩm khử mùi</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sản phẩm khử mùi</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
          ...
          <section>
            ...
            <DeodorantProductGrid products={filteredProducts} />
          </section>
        </div>
      </main>
