...
export default function BabyCarePage() {
  ...
  const categories = [
    { label: "Phụ kiện cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192839-0-P20532_1.png", link: "/phu-kien-cho-be" },
    { label: "Sản phẩm chống muỗi cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192726-0-P17661_1_l.png", link: "/san-pham-chong-muoi-cho-be" },
    { label: "Tã cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192839-0-P20532_1.png", link: "/ta-cho-be" },
    { label: "Tăm bông cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192726-0-P17661_1_l.png", link: "/tam-bong-cho-be" },
    { label: "Khăn ướt cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192839-0-P20532_1.png", link: "/khan-uot-cho-be" },
    { label: "Sữa dành cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192726-0-P17661_1_l.png", link: "/sua-danh-cho-be" },
    { label: "Chăm sóc cá nhân cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192839-0-P20532_1.png", link: "/cham-soc-ca-nhan-cho-be" },
    { label: "Sản phẩm chăm sóc sức khoẻ cho bé", imageUrl: "https://production-cdn.pharmacity.io/digital/144x144/plain/e-com/images/ecommerce/20240223192726-0-P17661_1_l.png", link: "/san-pham-cham-soc-suc-khoe-cho-be" },
  ];

  const brands = useMemo(() => {
    const babyCareProducts = momBabyProducts.filter(p => p.category === "Chăm sóc em bé");
    const allBrands = babyCareProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.category === "Chăm sóc em bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Chăm sóc em bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Chăm sóc em bé</h1>
