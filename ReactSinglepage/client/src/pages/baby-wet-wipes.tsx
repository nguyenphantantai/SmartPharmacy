...
export default function BabyWetWipesPage() {
  ...
  const brands = useMemo(() => {
    const wipesProducts = momBabyProducts.filter(p => p.subCategory === "Khăn ướt cho bé");
    const allBrands = wipesProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Khăn ướt cho bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Khăn ướt cho bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Khăn ướt cho bé</h1>
