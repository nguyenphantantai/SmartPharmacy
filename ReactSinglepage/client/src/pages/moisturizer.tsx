...
export default function MoisturizerPage() {
  ...
  const moisturizerProducts = useMemo(() => {
    return beautyCareProducts.filter(product => product.subCategory === "Kem dưỡng ẩm và dưỡng da");
  }, []);

  const brands = useMemo(() => {
    const allBrands = moisturizerProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = moisturizerProducts;
    ...
    return filtered;
  }, [moisturizerProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Kem dưỡng ẩm và dưỡng da</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Kem dưỡng ẩm và dưỡng da</h1>
