...
export default function BabyPersonalCarePage() {
  ...
  const brands = useMemo(() => {
    const personalCareProducts = momBabyProducts.filter(p => p.subCategory === "Chăm sóc cá nhân cho bé");
    const allBrands = personalCareProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Chăm sóc cá nhân cho bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Chăm sóc cá nhân cho bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Chăm sóc cá nhân cho bé</h1>
