...
export default function SanitaryPadsPage() {
  ...
  const sanitaryPadProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Băng vệ sinh");
  }, []);

  const brands = useMemo(() => {
    const allBrands = sanitaryPadProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = sanitaryPadProducts;
    ...
    return filtered;
  }, [sanitaryPadProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Băng vệ sinh</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Băng vệ sinh</h1>
