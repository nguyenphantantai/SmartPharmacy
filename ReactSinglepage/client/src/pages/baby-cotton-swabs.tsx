...
export default function BabyCottonSwabsPage() {
  ...
  const brands = useMemo(() => {
    const swabsProducts = momBabyProducts.filter(p => p.subCategory === "Tăm bông cho bé");
    const allBrands = swabsProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Tăm bông cho bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Tăm bông cho bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Tăm bông cho bé</h1>
