...
export default function OtherFeminineHygienePage() {
  ...
  const otherFeminineHygieneProducts = useMemo(() => {
    return personalCareProducts.filter(product => product.subCategory === "Sản phẩm vệ sinh khác");
  }, []);

  const brands = useMemo(() => {
    const allBrands = otherFeminineHygieneProducts.map((p) => p.brand);
    return Array.from(new Set(allBrands));
  }, [otherFeminineHygieneProducts]);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = otherFeminineHygieneProducts;
    ...
    return filtered;
  }, [otherFeminineHygieneProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/ve-sinh-phu-nu">Vệ sinh phụ nữ</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sản phẩm vệ sinh khác</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sản phẩm vệ sinh khác</h1>
