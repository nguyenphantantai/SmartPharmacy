...
export default function BabyMilkPage() {
  ...
  const brands = useMemo(() => {
    const milkProducts = momBabyProducts.filter(p => p.subCategory === "Sữa dành cho bé");
    const allBrands = milkProducts.map((p: MomBabyProduct) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = momBabyProducts.filter(p => p.subCategory === "Sữa dành cho bé");
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Sữa dành cho bé</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Sữa dành cho bé</h1>
