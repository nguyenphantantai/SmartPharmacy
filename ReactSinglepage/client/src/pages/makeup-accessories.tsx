...
export default function MakeupAccessoriesPage() {
  ...
  const makeupAccessoriesProducts = useMemo(() => {
    return beautyCareProducts.filter(product => product.subCategory === "Phụ kiện trang điểm");
  }, []);

  const brands = useMemo(() => {
    const allBrands = makeupAccessoriesProducts.map((p) => p.brand);
    return Array.from(new Set(allBrands));
  }, [makeupAccessoriesProducts]);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = makeupAccessoriesProducts;
    ...
    return filtered;
  }, [makeupAccessoriesProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/dung-cu-lam-dep">Dụng cụ làm đẹp</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Phụ kiện trang điểm</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Phụ kiện trang điểm</h1>
