...
export default function TonerMistPage() {
  ...
  const tonerMistProducts = useMemo(() => {
    return beautyCareProducts.filter(product => product.subCategory === "Nước hoa hồng & Xịt khoáng");
  }, []);

  const brands = useMemo(() => {
    const allBrands = tonerMistProducts.map((p) => p.brand);
  ...
  const filteredProducts = useMemo(() => {
    let filtered = tonerMistProducts;
    ...
    return filtered;
  }, [tonerMistProducts, priceRange, minPrice, maxPrice, selectedBrands]);
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Nước hoa hồng & Xịt khoáng</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>

        <h1 className="text-2xl font-bold mb-5">Nước hoa hồng & Xịt khoáng</h1>
